  ...
  public static boolean lerConfirmacao() {
    ...
    public static float leFloat(String palavra, String artigo){
      ...
      //do{
          ...
          //if(leitura.toLowerCase) // criar funcao para invalidar caracter
              //System.out.println("Entrada invalida, por favor insira novamente!");
      //}while(leitura.isEmpty());
      return leitura;
    }
    ...
    public static int leInt(String palavra, String artigo){
      ...
      //do{
          ...
          //if(leitura.isEmpty()) // criar funcao para invalidar caracter
              //System.out.println("Entrada invalida, por favor insira novamente!");
      //}while(leitura.isEmpty());
      return leitura;
    }
    ...
    public static Date leData(String palavra, String artigo) throws ParseException{
      ...
      // >>>>>>>>>>>>>>>>>> ler a data como string e formatar para o tipo Date
      // >>>>>>>>>>>>>>>>>> Ferificar o formato da data

      // do{
      //     System.out.print("Insira "+ artigo + " " + palavra + ": ");
      //     leitura = input.nextLine();
      //     if(cpfValido(leitura) == false)
      //         System.out.println("Entrada invalida, use apenas numeros. \nEvite o uso de caracteres como: '.', '-', '/'.\npor favor tente novamente!");
      // }while(cpfValido(leitura) != true);
      return data;
    }
